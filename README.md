...
This project is a web-based application that allows patients to:
...
- View doctors with availability status  
- Generate token and join queue  
...
- Logic: Vanilla JavaScript (no backend required for demo)
...
1. Clone the repository: git clone https://github.com/your-username/hospital-queue-system.git
2. Navigate to the folder: cd hospital-queue-system
3. Open the project: Open index.html in your browser  
